...
```{r Meeting w/ Yoav--clean info}
#First, for each different locus bin size available (10kb, 20kb, 30kb, 40kb), produce a boxplot across distance bins of means of contact counts for each chromosome.
...
for(chr in genome){
  ...
  overlap.visualizer(overlap.10kb.GW, chr)
}
...
#Need to add something in to function to prevent me from having to do this, even.
overlap.10kb.GW$chr <-c(rep("chr1", 205), rep("chr2", 205), rep("chr3", 205), rep("chr4", 205), rep("chr5", 205), rep("chr6", 205), rep("chr7", 205), rep("chr8", 205), rep("chr9", 205), rep("chr10", 205), rep("chr11", 205), rep("chr12", 205), rep("chr13", 205), rep("chr14", 205), rep("chr15", 205), rep("chr16", 205), rep("chr17", 205), rep("chr18", 205), rep("chr19", 205), rep("chr20", 205), rep("chr21", 205), rep("chr22", 205), rep("chrX", 205), rep("chrY", (nrow(overlap.10kb.GW)-205*23)))

overlap.20kb.GW$chr <-c(rep("chr1", 205), rep("chr2", 205), rep("chr3", 205), rep("chr4", 205), rep("chr5", 205), rep("chr6", 205), rep("chr7", 205), rep("chr8", 205), rep("chr9", 205), rep("chr10", 205), rep("chr11", 205), rep("chr12", 205), rep("chr13", 205), rep("chr14", 205), rep("chr15", 205), rep("chr16", 205), rep("chr17", 205), rep("chr18", 205), rep("chr19", 205), rep("chr20", 205), rep("chr21", 205), rep("chr22", 205), rep("chrX", 205), rep("chrY", 130))

overlap.30kb.GW$chr <-c(rep("chr1", 205), rep("chr2", 205), rep("chr3", 205), rep("chr4", 205), rep("chr5", 205), rep("chr6", 205), rep("chr7", 205), rep("chr8", 205), rep("chr9", 205), rep("chr10", 205), rep("chr11", 205), rep("chr12", 205), rep("chr13", 205), rep("chr14", 205), rep("chr15", 205), rep("chr16", 205), rep("chr17", 205), rep("chr18", 205), rep("chr19", 205), rep("chr20", 205), rep("chr21", 205), rep("chr22", 205), rep("chrX", 205), rep("chrY", 130))

overlap.40kb.GW$chr <-c(rep("chr1", 205), rep("chr2", 205), rep("chr3", 205), rep("chr4", 205), rep("chr5", 205), rep("chr6", 205), rep("chr7", 205), rep("chr8", 205), rep("chr9", 205), rep("chr10", 205), rep("chr11", 205), rep("chr12", 205), rep("chr13", 205), rep("chr14", 205), rep("chr15", 205), rep("chr16", 205), rep("chr17", 205), rep("chr18", 205), rep("chr19", 205), rep("chr20", 205), rep("chr21", 205), rep("chr22", 205), rep("chrX", 205), rep("chrY", 130))
```
