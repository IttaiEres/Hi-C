...
homer.10kb.sigs <- homer.10kb.chr22[homer.10kb.chr22$distance<15000&homer.10kb.chr22$distance>=10000,2:3]

my.10kb.sigs <- data.22[data.22$bin==10000&data.22$count>=sig.22["10000", "0.05"], 3:4]
colnames(my.10kb.sigs) <- c("loc1_bin", "loc2_bin")

test <- merge(homer.10kb.sigs, my.10kb.sigs) #YES! Works well :)
